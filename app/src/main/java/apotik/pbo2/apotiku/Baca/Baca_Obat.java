...
import apotik.pbo2.apotiku.Request.Baca_Request;
import apotik.pbo2.apotiku.SharedPreffrence.Session1;

public class Baca_Obat extends AppCompatActivity {
    ...
    private void getObatData() {
        ...
        Baca_Request baca_request = new Baca_Request(idApotik, listener);
        RequestQueue requestQueue = Volley.newRequestQueue(Baca_Obat.this);
